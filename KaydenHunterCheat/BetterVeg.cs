...
namespace KaydenHunterCheat
{
    class BetterVeg : IInjection
    {
        ...
        public IntPtr enable(IntPtr addresToUse, ulong playerObject = 0)
        {
            ...
            bool status = mem.WriteByteArray(VirtAlloc, new byte[] { 0xC7, 0x83, 0x94, 0xD8, 0x11, 0x00, 0x00, 0x00, 0x20, 0x42, 0xE9, jmpReltiveBytes[0], jmpReltiveBytes[1], jmpReltiveBytes[2], jmpReltiveBytes[3], 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 });
            if(status != true)
            {
